...
- **[Limitless Exchange](https://limitless.exchange/)** — Base prediction market; public read-only market, search, detail, and orderbook APIs. Integrated as a scanned venue only; trading execution is not wired.
